    ...
    <div className="pt-20 w-full min-h-screen px-2  pb-10">
      <div className="text-black flex flex-col items-center gap-2 py-5 ">
        ...
        <p className="text-center">
          ...
          orders, and enjoy personalized shopping experiences. It's quick, easy,
          and free. Let's get started on your journey to seamless online
          shopping with SwiftCart.
        </p>
      </div>
      ...
      <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
        <label className="input input-bordered flex items-center gap-2">
          ...
          <input type="text" className="grow capitalize" placeholder="Fullname" 
      ...
      {error ? (
        <div role="alert" className="alert alert-error flex items-center justify-start text-white mt-5">
