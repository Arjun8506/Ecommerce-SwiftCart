...
const Login = () => {
  ...
  return (
    <div className="pt-20 w-full min-h-screen px-2 bg-orange-400 pb-10">
      ...
      <p className="text-center">Log in to SwiftCart to access your account, track orders, and enjoy personalized offers. Forgot your password? Reset it easily. New here? Join us for a seamless shopping experience.</p>
        </div>
